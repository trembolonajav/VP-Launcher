...
const T = {
  ...
  READY:["HUNTING","PAUSED","ACTION_RUNNING","NETWORK_CHECK","AUTH_CHECK","RECOVERING","ERROR","CLOSED"],
  HUNTING:["READY","PAUSED","ACTION_RUNNING","NETWORK_CHECK","RECOVERING","ERROR","CLOSED"],
  PAUSED:["READY","HUNTING","NETWORK_CHECK","RECOVERING","ERROR","CLOSED"],
  ...
  RECOVERING:["NETWORK_CHECK","AUTH_CHECK","READY","HUNTING","WAITING_USER","ERROR","CLOSED"],
