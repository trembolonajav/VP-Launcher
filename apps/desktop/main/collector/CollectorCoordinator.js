...
export class CollectorCoordinator {
  constructor(repository, events, sessionRunIds) { this.repository = repository; this.events = events; this.sessionRunIds = sessionRunIds; this.states = new Map(); this.lastSamples = new Map(); }
