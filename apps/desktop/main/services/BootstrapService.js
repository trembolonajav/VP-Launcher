...
export class BootstrapService {
  ...
  run(seed) {
    ...
    this.database.prepare("INSERT OR IGNORE INTO network_profiles(id,name,type,config_json,enabled,created_at,updated_at) VALUES('network:direct','Direta','DIRECT','{}',1,?,?)").run(now, now);
