...
contextBridge.exposeInMainWorld("vpNative", {
  ...
  testNetwork: id => ipcRenderer.invoke("vp:test-network", id),
  reconnectNetwork: id => ipcRenderer.invoke("vp:reconnect-network", id),
  changeNetworkProfile: payload => ipcRenderer.invoke("vp:change-network-profile", payload),
